...
const ProductCards = ({heading, cards}) => {
    return (
        <>
            ...
            >
                {
                    cards.map(item => (
                        <SwiperSlide key={item.id} className="new-arrival-card w-[340px] h-[480px]">
                            <NavLink to={`product/${item.id}`} className="w-full h-full">
            ...
            <div className="navigations px-14 flex gap-5 absolute bottom-0 lg:bottom-[50%] lg:-translate-y-[50%] lg:w-full lg:justify-between left-[50%] -translate-x-[50%] z-10">
