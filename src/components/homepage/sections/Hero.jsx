...
const Hero = () => {
    ...
    return (
        <header className='hero-section relative h-fit lg:h-screen max-h-[768px] w-full pt-[20vh] lg:py-[10vh] flex lg:flex-col flex-col-reverse gap-10 items-center justify-center lg:justify-between'>
            ...
            <div className="heading-container w-full h-fit overflow-hidden pb-[1.5vh]">
                <div className="main-heading flex-shrink-0 w-full">
                    <h1 className='w-full h-fit bg-[#fff] mix-blend-lighten flex justify-center text-[6.8rem] lg:text-[22rem] 2xl:text-[25rem] leading-none tracking-[-5px] lg:tracking-[-10px]'>
                        {
