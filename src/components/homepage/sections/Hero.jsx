...
const Hero = () => {
    ...
    return (
        <header className='hero-section relative h-screen max-h-[768px] w-full py-[10vh] flex flex-col items-center justify-between'>
            <div className=" w-full relative z-[10] px-5 flex justify-between bg-[#fff]">
            ...
            <div className="main-heading flex-shrink-0 w-full">
                <h1 className='w-full bg-[#fff] mix-blend-lighten flex justify-center text-[22rem] leading-none tracking-[-10px]'>
                    {
            ...
            <img className='shoeImg absolute bottom-[3vh] left-[50%] -translate-x-[50%] h-[95vh] max-h-[800px] z-10' src="../../../../assets/images/shoeNobgL.png" alt="Nike Shoe Img"/>
        </header>
    )
}
